...
- **删除任务**：从任务列表中移除任务
- **标记完成**：勾选任务完成状态或自动完成（达到预估时长）
- **筛选任务**：支持"全部/进行中/已完成"筛选
- **进度追踪**：实时显示任务完成进度（已完成分钟数/总分钟数）
...
### ⏱️ 番茄钟专注
- **智能时长**：专注时长自动设置为任务的预估时长，无需手动调整
- **倒计时**：支持自定义专注时长和休息时长（默认5分钟休息）
- **声音提醒**：倒计时结束播放提示音
- **任务联动**：与选中的任务绑定，记录任务完成进度
- **连续进度**：基于实际完成分钟数的连续进度显示，不再间断化
- **重置功能**：支持暂停和重置计时器
...
- [x] 集成真实的LLM API进行自然语言解析和智能排期（已完成：使用DeepSeek API）
- [ ] 增强智能排期功能，支持更复杂的时间冲突检测和优化
- [ ] 添加任务标签和分类功能
- [ ] 支持团队协作和任务分享
- [ ] 添加数据统计和报告功能
- [ ] 支持多主题切换
